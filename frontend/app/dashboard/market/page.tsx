...
export default function MarketPage() {
  ...
  // 価格履歴（12ヶ月）
  const priceHistory = [
    { month: "Jan", price: 8.50 },
    { month: "Feb", price: 8.70 },
    { month: "Mar", price: 8.90 },
    { month: "Apr", price: 9.20 },
    { month: "May", price: 9.50 },
    { month: "Jun", price: 9.80 },
    { month: "Jul", price: 10.00 },
    { month: "Aug", price: 10.20 },
    { month: "Sep", price: 10.10 },
    { month: "Oct", price: 10.30 },
    { month: "Nov", price: 10.25 },
    { month: "Dec", price: 10.00 },
  ];
        ...
        <div style={{ position: "relative", height: "200px", marginBottom: "16px" }}>
          ...
          >
            {priceHistory.map((p, i) => (
              <div key={i} style={{ fontSize: "10px", color: "#6b7280", textAlign: "center" }}>
                {p.month}
              </div>
            ))}
          </div>
