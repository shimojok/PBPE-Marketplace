...
- **PBPE Marketplace (Impact Version)**  
  [PBPE_Marketplace_en_s.pdf](./slides/PBPE_Marketplace_en_s.pdf)

- **Planetary Health Unified API (Full PBPE Model)**  
  [The_Planetary_Health_Unified_API_s.pdf](./slides/The_Planetary_Health_Unified_API_s.pdf)

- **PH‑API (Impact Engine / 7‑Digit Code Integration)**  
  [PH-API_s.pdf](./slides/PH-API_s.pdf)
